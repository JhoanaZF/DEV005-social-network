...
const postsCollection = _h(db, "posts");
df(postsCollection);
...
const paintPostsRealTime = (postsCallback) => {
  If(Rl(_h(db, "posts"), xl("date", "desc")), (querySnapshot) => {
    postsCallback(querySnapshot);
  });
};
const deletePost = (id2) => new Promise((resolve, reject) => {
  yf(gh(Ph(), "posts", id2)).then((res) => resolve(res)).catch((error2) => reject(error2));
});
const editPost = (id2, newFields) => new Promise((resolve, reject) => {
  gf(gh(Ph(), "posts", id2), newFields).then((res) => resolve(res)).catch((error2) => reject(error2));
});
const aboutLikes = (id2, userId) => new Promise((resolve, reject) => {
  gf(gh(Ph(), "posts", id2), { likes: Qf(userId) }).then((res) => resolve(res)).catch((error2) => reject(error2));
});
const aboutDislikes = (id2, userId) => new Promise((resolve, reject) => {
  gf(gh(Ph(), "posts", id2), { likes: jf(userId) }).then((res) => resolve(res)).catch((error2) => reject(error2));
});
const checkEdit = "https://firebasestorage.googleapis.com/v0/b/social-network-424d1.appspot.com/o/img%2FcheckEdit.svg?alt=media&token=af72797b-b84c-4cff-913d-bd4522db541e";
const errorOutline = "https://firebasestorage.googleapis.com/v0/b/social-network-424d1.appspot.com/o/img%2FerrorOutline.svg?alt=media&token=29f454c4-2df5-4277-b673-2fc9c688744a";
const google = "https://firebasestorage.googleapis.com/v0/b/social-network-424d1.appspot.com/o/img%2Fgoogle.svg?alt=media&token=0e916d3a-53b3-4461-8aef-f95b0c440091";
const grayLike = "https://firebasestorage.googleapis.com/v0/b/social-network-424d1.appspot.com/o/img%2FgrayLike.svg?alt=media&token=4dec3ef1-3d1b-4c97-8888-4326933e3021";
const iconDelete = "https://firebasestorage.googleapis.com/v0/b/social-network-424d1.appspot.com/o/img%2FiconDelete.svg?alt=media&token=faa6ec51-e105-4286-ba16-5ec88b699be6";
const iconEdit = "https://firebasestorage.googleapis.com/v0/b/social-network-424d1.appspot.com/o/img%2FiconEdit.svg?alt=media&token=7880ac8e-5604-4a94-96ea-c4ab7cc8c695";
const iconSignOut = "https://firebasestorage.googleapis.com/v0/b/social-network-424d1.appspot.com/o/img%2FiconSignOut.svg?alt=media&token=e702f267-6e86-4e3c-bf62-4cef6186f152";
const logo = "https://firebasestorage.googleapis.com/v0/b/social-network-424d1.appspot.com/o/img%2Flogo.svg?alt=media&token=e16d6629-e82b-49b9-8c70-7c9a2744d06d";
const logoHome = "https://firebasestorage.googleapis.com/v0/b/social-network-424d1.appspot.com/o/img%2FlogoHome.svg?alt=media&token=98e05bae-680f-463d-9f3c-1f016af440e6";
const redLike = "https://firebasestorage.googleapis.com/v0/b/social-network-424d1.appspot.com/o/img%2FredLike.svg?alt=media&token=6cdee81e-6bf0-4ba7-876c-d2b184e330d7";
const sports = "https://firebasestorage.googleapis.com/v0/b/social-network-424d1.appspot.com/o/img%2Fsports.svg?alt=media&token=104acd0c-ab09-4e10-b3d8-71302c9bf102";
const welcome = (findRouteAndNavigate2) => {
  ...
  const viewWelcome = `
    ...
    <div class="buttonsLR">
        <article class="textLR">
            <a class="registerBtn" id="registerBtn">Reg\xEDstrate</a>
            <span class="line">|</span>
            <a class="loginBtn" id="loginBtn">Inicia sesi\xF3n</a>
        </article>
    </div>
</div>
`;
...
const loginLogic = (container) => {
  ...
  const validateFields = () => {
    ...
    if (!emailRegex.test(mailUserLogin.value)) {
      showError("Ingresa un correo electr\xF3nico v\xE1lido.", "messageErrorMailLogin");
      return { errors: true };
    }
    showError("", "messageErrorMailLogin");
    if (!passwordUserLogin.value) {
      showError("Ingresa una contrase\xF1a", "messageErrorPasswordLogin");
      return { errors: true };
    }
  ...
  loginBtn.addEventListener("click", async () => {
    try {
      ...
      console.log(error2);
      showError("El correo o la contrase\xF1a es incorrecta", "messageErrorPasswordLogin");
    }
  });
...
const login = (findRouteAndNavigate2) => {
  const container = document.createElement("section");
  ...
  const viewLogin = `
    <div class="two">
        ...
        <article>
            <div class="fields">
                <label class="labelLR"> Correo Electr\xF3nico </label>
            ...
            <div class="fields">
                <label class="labelLR">Contrase\xF1a </label>
        ...
        <div class="buttonsStartSession">
            <div class="loginBtn">
            <button  id="loginBtn" class="lBtn" type="submit">Iniciar Sesi\xF3n</button>
            </div>
            ...
            <div class="returnRegistration">
                <span class="spanText">\xBFNo tienes cuenta?</span>
                <a id="registerBtn" class="aText">Reg\xEDstrate</a>
            </div>
        </div>
    </div>
`;
...
const registerLogic = (container) => {
  ...
  const validateFields = () => {
    ...
    if (!userMailRegister.value) {
      showError("Ingresa un correo electr\xF3nico.", "messageErrorMailRegister");
      return { errors: true };
    }
    showError("", "messageErrorMailRegister");
    if (!emailRegex.test(userMailRegister.value)) {
      showError("Ingresa un correo electr\xF3nico v\xE1lido.", "messageErrorMailRegister");
      return { errors: true };
    }
    showError("", "messageErrorMailRegister");
    if (!userPasswordRegister.value) {
      showError("Ingresa una contrase\xF1a.", "messageErrorPasswordRegister");
      return { errors: true };
    }
  ...
  registerBtn.addEventListener("click", async () => {
    try {
      ...
      console.log(error2);
      showError("Ocurri\xF3 un error al intentar registrar el usuario. Por favor, intenta nuevamente.", "messageErrorPasswordRegister");
    }
  });
};
const register = (findRouteAndNavigate2) => {
  const container = document.createElement("section");
  container.classList.add("contentLR");
  const viewRegister = ` 
    <article class="three">
    ...
    <div>
        ...
        <div class="buttonsRegistration">
            ...
            <div class="returnHomeSession">
                <span class="spanText">\xBFYa tienes cuenta?</span>
                <a id="loginBtn" class="aText">Iniciar Sesi\xF3n</a>
            </div>
        </div>
    </div>
</article>
    ...
    <div class="contentHome">
        ...
        <div class="userNameHome">
            ...
            <div class="myPublication">
                <textarea type="text" placeholder="\xBFEn qu\xE9 est\xE1s pensando ahora?" id="commentField" class="commentField" rows="3" cols="30" style="resize: none"> </textarea>
